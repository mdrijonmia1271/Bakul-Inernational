...
public function show() {
    ...
    if (!empty($_GET['vno'])) {
        ...
        if ($voucherInfo->party_type == 'cash') {
            ...
            $partyInfo['code']    = '';
            $partyInfo['name']    = !empty($cInfo->name) ? $cInfo->name : 'NA';
            $partyInfo['mobile']  = !empty($cInfo->mobile) ? $cInfo->mobile : 'NA';
            $partyInfo['address'] = !empty($cInfo->address) ? $cInfo->address : 'NA';

        } else {
            $pInfo = get_row('parties', ['code' => $voucherInfo->party_code], ['name', 'mobile', 'address']);

            $partyInfo['code']    = $voucherInfo->party_code;
            $partyInfo['name']    = !empty($pInfo->name) ? $pInfo->name : 'NA';
            $partyInfo['mobile']  = !empty($pInfo->mobile) ? $pInfo->mobile : 'NA';
            $partyInfo['address'] = !empty($pInfo->address) ? $pInfo->address : 'NA';
        }
        ...
        $this->data['voucherItems'] = get_left_join(
            'replace_items',
            'products',
            'replace_items.product_code=products.product_code',
            $where,
            $select
        );
