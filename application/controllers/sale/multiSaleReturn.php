...
class MultiSaleReturn extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['return'])) {
            ...
            $content = "নামঃ " . filter($customer_name->name) . ", বিল নংঃ " . $this->data['invoice'] . ", ফেরত বিল এমাউন্ট " . $this->input->post("total") . " Tk, " . ", গ্রহণ : " . $this->input->post('paid') . " Tk, পূর্বের ব্যালেন্স : " . $this->input->post("previous_balance") . " Tk, বর্তমান ব্যালেন্স : " . $this->input->post("current_balance") . " Tk,  তাংঃ " . $this->input->post('date') . "বিল্লাহ্ সেন্টার";
