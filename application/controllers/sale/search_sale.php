...
class Search_sale extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['show'])) {
            ...
            if($_POST['product_serial']){
                $like['product_serial'] = $_POST['product_serial'];
            }
    ...
    public function customer($party_code)
    {
        ...
        // get all client
        $clientWhere              = array('code' => $party_code, 'type !=' => 'supplier', 'trash' => 0);
    ...
    private function getAllClient($type = null)
    {
        ...
        if (!empty($type)) {
            $clientWhere['customer_type'] = 'dealer';
        } else {
            $clientWhere['customer_type ='] = 'dealer';
        }
