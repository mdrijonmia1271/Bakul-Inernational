...
class Balance_report extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['show'])) {
            ...
            $whereSap      = ['sap_at' => date('Y-m-d'), 'saprecords.godown_code' => $this->data['branch']];
        ...
        $select = ['partytransaction.transaction_at', 'partytransaction.credit', 'partytransaction.debit', 'partytransaction.inc_code',  'partytransaction.party_code', 'parties.name', 'parties.customer_type'];
        $this->data['dealerPayment']   = get_join('partytransaction', 'parties', 'partytransaction.party_code=parties.code', $dealerWhere, $select);
        
        $dealerWhere['parties.customer_type'] = 'sub_dealer';
        $this->data['subDealerPayment']   = get_join('partytransaction', 'parties', 'partytransaction.party_code=parties.code', $dealerWhere, $select);
        
        $dealerWhere['parties.customer_type'] = 'user';
        $this->data['userDealerPayment']   = get_join('partytransaction', 'parties', 'partytransaction.party_code=parties.code', $dealerWhere, $select);
        ...
        $supplierWhere['comment !=']     = 'comission';
