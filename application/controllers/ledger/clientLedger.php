...
class ClientLedger extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['show'])) {
            ...
            $this->data['resultset'] = get_result('partytransaction', $where, ['transaction_at', 'remark', 'comment', 'relation', 'previous_balance', 'inc_code', 'debit', 'comission', 'credit', 'remission']);
    ...
    public function getDefaultData($c_type) {
        ...
        if(!(empty($allClient))){
            ...
            foreach ($allClient as $key => $value) {
                ...
                $allTransaction = get_result('partytransaction', $where, ['godown_code', 'debit', 'comission', 'credit', 'remission', 'comment']);
