...
class Commitment extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['add'])) {
            ...
            // input data
            $data = input_data(['godown_code', 'user_id', 'party_code', 'commitment', 'date', 'status']);
    ...
    public function view($id)
    {
        ...
        $select = ['commitments.*', 'commitments.status', 'parties.name', 'parties.mobile', 'parties.address', 'godowns.name as godown_name', 'users.name as user_name'];
