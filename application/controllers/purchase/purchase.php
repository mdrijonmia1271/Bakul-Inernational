...
class Purchase extends Admin_Controller
{
    ...
    private function create()
    {
        ...
        foreach ($_POST['product'] as $key => $value) {
            ...
            $data['retail_sale_price']   = $_POST['retail_sale_price'][$key];
            $data['dealer_sale_price']   = $_POST['dealer_sale_price'][$key];
    ...
    private function handelStock($index)
    {
        ...
        if ($record != null) {
            $data = array(
                ...
                'dealer_a_price'   => $_POST['dealer_a_price'][$index],
                'dealer_b_price'   => $_POST['dealer_b_price'][$index],
                'dealer_c_price'   => $_POST['dealer_c_price'][$index],
                'quantity' => $quantity
            );
            ...
            $data = array(
                ...
                'sell_price'       => $_POST['sale_price'][$index],
                'retail_sale_price'=> $_POST['retail_sale_price'][$index],
    ...
    {
        $result = get_result("products", ["status" => "available"], ['product_code', 'product_name', 'product_model', 'brand']);
        return $result;
    }
    ...
    public function show_purchase()
    {
        ...
        $this->data['allModel'] = get_result('products', ['status' => 'available'], ['product_model', 'brand']);
