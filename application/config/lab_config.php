<?php
// set site name
$config['site_name']   = 'Rafiq Electronics';
$config['my_database'] = 'wwwtalukderent_rafiqelectronics';
...
// dealer type
$config['dealer_type'] = ['RE', 'ME', 'NT', 'Wholesale'];
...
$config['unit'] = array("Pcs","Feet","Bandle","KG","Litre", "Set", "Watt");
// Cost purpose
