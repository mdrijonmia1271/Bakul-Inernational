        ...
        <ul class="sidebar-nav">
            ...
            <li id="raw_stock_menu">
                <a href="<?php echo site_url('stock/stock'); ?>">
                    <i class="fa fa-bar-chart" aria-hidden="true"></i> &nbsp;11. Stock
                </a>
            </li>
            <?php } ?>
            
             <?php if(ck_menu("raw_stock_menu_date")){ ?>
                ...
                <ul id="sales" class="sidebar-nav collapse">
                    ...
                    <li>
                        <a href="<?php echo site_url('sale/dealerSale'); ?>">
			                <i class="fa fa-angle-right"></i> 04. Dealer Sale
		                </a>
                    </li>
                    <?php } ?>
                    ...
                    <li>
                        <a href="<?php echo site_url('sale/DealerChalan'); ?>">
			                <i class="fa fa-angle-right"></i> 05. Dealer Chalan
		                </a>
                    </li>
                    <?php } ?>
