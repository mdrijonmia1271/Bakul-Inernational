        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr  class="active">
                            <th rowspan="2" width="200" class="text-center" style="vertical-align: middle;">Menu Item</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="dashboard" data-item="action" value="retail_sale">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Retail Sale
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="dashboard" data-item="action" value="hire_sale">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Hire Sale
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="dashboard" data-item="action" value="weekly_sale">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Weekly Sale
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="dashboard" data-item="action" value="dealer_sale">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Dealer Sale
                                  </label>
                                </div>
                        ...
                        <tr>
                            <th>
                                <div class="checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-item="menu" value="godown_menu">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    <span style="margin-left: 10px;">Showroom</span>
                                  </label>
                                </div>
                            </th>
                            ...
                            <td colspan="3" width="320">
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="godown_menu" data-item="action" value="add-new">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Add New
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="godown_menu" data-item="action" value="all">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;View All
                                  </label>
                                </div>
                        ...
                        <tr>
                            <th>
                                <div class="checkbox checkbox-inline view">
                                    <label>
                                        <input type="checkbox" data-item="menu" value="party_menu">
                                        <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                        <span style="margin-left: 10px;">Supplier/Client</span>
                                    </label>
                                </div>
                            </th>
                            ...
                            <td colspan="3" width="320">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                    <label>
                                        <input type="checkbox" data-menu="party_menu" data-item="action" value="create">
                                        <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                        &nbsp; Add New
                                    </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                    <label>
                                        <input type="checkbox" data-menu="party_menu" data-item="action" value="list">
                                        <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                        &nbsp; View All
                                    </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                    <label>
                                        <input type="checkbox" data-menu="party_menu" data-item="action"
                            ...
                            <th>
                                <div class="checkbox checkbox-inline view">
                                  <label>
                                    ...
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    <span style="margin-left: 10px;">Zone</span>
                                  </label>
                                </div>
                            </th>
                      ...
                      <!-- Row Start here -->
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="320">
                               ...
                               <div class="deshitem checkbox checkbox-inline view">
                                ...
                                <!--<div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="sale_menu" data-item="action" value="hire-all">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;All Hire Sale
                                  </label>
                                </div>-->
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="sale_menu" data-item="action" value="client_search">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Search Client Wise
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="sale_menu" data-item="action" value="multi-return">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Sale Return
                                  </label>
                                </div>
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="sale_menu" data-item="action" value="multi-return-all">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;All Sale Return
                                  </label>
                                </div>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="320">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="due_list_menu" data-item="action" value="dealer">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Dealer Due
                                  </label>
                                </div>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="320">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="bank_menu" data-item="action" value="all_trx">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;All Transaction
                                  </label>
                                </div>
                        ...
                        <!--<tr>
                            ...
                            <td colspan="3" width="320">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="ledger" data-item="action" value="customer-ledger">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;Customer Ledger
                                  </label>
                                </div>
                        ...
                        <tr>
                            <th>
                                <div class="checkbox checkbox-inline view">
                                    <label>
                                        <input type="checkbox" data-item="menu" value="party-ledger">
                                        <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                        <span style="margin-left: 10px;">Ledger</span>
                                    </label>
                                </div>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="320">
                                ...
                                <div class="deshitem checkbox checkbox-inline view">
                                  <label>
                                    <input type="checkbox" data-menu="report_menu" data-item="action" value="sale_profit">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                                    &nbsp;sale Profit
                                  </label>
                                </div>
