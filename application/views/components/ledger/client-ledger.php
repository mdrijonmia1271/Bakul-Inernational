                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($defaultData as $key => $row) {
                            ...
                            <tr>
                                ...
                                <?php
                                if ($row['init_status'] == "Receivable") {
                                    $init_status = '';
                                } else {
                                    $init_status = ' -';
                                }
                                ?>
                                <td><?php echo $init_status . f_number(abs($row['init'])); ?></td>
                                <td>
                                    <?php echo f_number($row['credit']);
                                    $totalCredit += $row['credit']; ?>
                                    <?php if ($row['toal_remission'] > 0) { ?>
                                        <small style="color:red; font-weight:800;">
                                            Remission: <?php echo f_number($row['toal_remission']); ?>
                                        </small>
                                    <?php } ?>
                                </td>
                                <td><?php echo f_number($row['debit']);
                                    $totalDebit += $row['debit']; ?></td>
                                <td>
                                    <?php
                                    $balance = 0.0;
                                    ...
                                    $status2 = ($balance >= 0) ? "" : "-";
                                    echo $status2 . ' ' . f_number(abs($balance));
                                    $grandTotal += $balance;
                                    ?>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <strong><?php // echo ($grandTotal >= 0) ? "Receivable" : "Payable";
                            ?></strong>
                        </th> -->
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php //echo abs($opening_balance)." TK "."&nbsp;[ ".$opening_status." ]"; ?>
                            </td>
                        </tr>
                        <!-- previous balance row end here -->
                        <?php
                        $totalDebit  = $total = $totalCredit = $stepBalance = $grandtotalQuant = $commission = $totalCommission = 0.00;
                        ...
                        foreach ($resultset as $key => $row) {
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($row->debit, 2);
                                    $debit      = $row->debit;
                                    $totalDebit += $row->debit; ?>
                                </td>
                                <!-- <td><?php // echo  number_format($commission,2);$commission = $row->comission; $totalCommission += $row->comission; ?> -->
                                </td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <?php
                                    $stepBalance += ($debit - $credit + $commission);
                                    //$step_status = ($stepBalance < 0 )? "Payable":"Receivable";
                                    $step_status = ($stepBalance < 0) ? " -" : " ";
                                    echo $step_status . f_number(abs($stepBalance), 2);
                                    ?>
                                </td>
                                <!--    <td class="none">-->
                        ...
                        <tr>
                            ...
                            <th><strong>
                                    <?php
                                    $balance = $totalDebit - $totalCredit + $opening_balance + $totalCommission;
                                    //$balance_status = ($balance < 0 )? "Payable":"Receivable";
                                    $balance_status = ($balance < 0) ? " -" : " ";
                                    echo $balance_status . f_number(abs($balance), 2);
