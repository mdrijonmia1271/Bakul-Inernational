        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title ">
                    <h1 class="pull-left">
                        Show Result
                        &nbsp;&nbsp;<small>(<?php echo filter($productInfo[0]->product_name); ?>) </small>
                     </h1>
            ...
            <div class="panel-body">
                ...
                <h5 class="text-center hide" style="margin-top: 5px;">
                    Products : <?php echo filter($_POST['product_code']); ?>
                </h5>
                <table class="table table-bordered table2">
                    ...
                    foreach($result as $key => $val){
                        ...
                        <tr>
                            ...
                            <td ><?php echo d_formate($val->sap_at); ?></td>
