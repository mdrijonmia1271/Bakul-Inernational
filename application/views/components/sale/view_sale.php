            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 print-font">
                        ...
                        <label>Address : <?php echo $address; ?> </label>
                        <?php }else{ ?>
                            <label>Print Time : <?php echo d_formate($result[0]->sap_at); ?> - <?php echo date("h:i:s A"); ?></label>
                        <?php } ?>
                    </div>
                    <?php if($result[0]->sap_type == "cash" ) { ?>
                    <div class="col-xs-4 print-font">
                        <label>Print Time : <?php echo d_formate($result[0]->sap_at); ?> - <?php echo date("h:i:s A"); ?></label> <br>
                    </div>
                    <?php } ?>
                </div>
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th rowspan="6" colspan="5" style="padding-top: 55px;">
