            ...
            <div class="panel-body" ng-click>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"> Total Old Return Amount</label>
                            <div class="col-md-8">
                                <input type="text" name="total_return_old" ng-model="total_return" class="form-control"
                                       step="any" readonly>
                            </div>
                        </div>                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 <input type="text" name="total_new_return"  ng-model="total_new_return" ng-value="getTotalNewReturnFn()" class="form-control"
                                       step="any" readonly>       
                            </div>
                        </div>   
                         ...
                         <div class="form-group" ng-if="getCurrentTotalFn() >0">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="date" name="commitment_date"  class="form-control"
                                       value="<?php echo get_name('saprecords','commitment_date',['voucher_no' => $_GET['vno']]); ?>"    required>
