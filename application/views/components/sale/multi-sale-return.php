            ...
            <div class="panel-body" ng-cloak>
                ...
                <div class="row">
                    ...
                    <?php if (checkAuth('super')) { ?>
                        <div class="col-md-3">
                            <select class="form-control" ng-init="godown_code='<?php echo $this->data["branch"]; ?>'" ng-model="godown_code" ng-value="godown_code">
                    ...
                    <div class="col-md-4">
                        <select ui-select2="{ allowClear: true}" class="form-control" ng-model='product_code'
                            ...
                            <option ng-repeat="product in allProducts" value="{{product.code}}">
                                {{product.product_model | textBeautify }}
                            </option>
                        </select>
                    </div>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            <input type="text" class="form-control" name="product_model[]" ng-value="item.product_model"
                                   readonly>
                        </td>
                        ...
                        <td>
                            <input type="text" name="quantity[]" class="form-control" min="0" ng-model="item.quantity"
                                   step="any">
                        </td>

                        <td>
                            <input type="number" name="return_price[]" class="form-control" min="0"
                  ...
                  <textarea name="address" class="form-control"
                    ...
                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <select class="form-control" name="meta[commission]" ng-model="commission"
                                            ...
                                            <?php } ?>
                                            <input type="hidden" name="meta[remaining_commission]"
                                                   ng-value="remaining_commission">
                                        </select>
                                    </div>

                                    <div class="col-md-5">
                                        <input type="text" name="total_commission" ng-model="total_commission_amount"
                                               class="form-control"
                                               readonly>
                                    </div>
                                </div>
                        ...
                        <div class="form-group hide">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="discount" ng-model="total_discount" min="0"
                        ...
                        <div class="form-group hide">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="sub_total" ng-value="getGrandTotalFn()" class="form-control"
                                       step="any"
                                       readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group hide">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                                        <select class="form-control" name="meta[extra_commission]"
                                                ng-model="extraCommission"
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="extra_commission" ng-model="extra_commission_amount"
                                               class="form-control"
                                               readonly>
                                    </div>
                                </div>
                        ...
                        <div class="form-group hide">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="grand_total" ng-value="GrandTotalFn()" class="form-control"
                                       step="any"
                                       readonly>
                            </div>
                        </div>
