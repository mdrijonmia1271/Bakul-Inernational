            ...
            <div class="panel-body" ng-cloak>
                    ...
                    <div class="col-md-3">
                        ...
                        <select ui-select2="{ allowClear: true}" class="form-control" ng-model='return_product_code'
                            ...
                            <option ng-repeat="ReturnProduct in allReturnProducts"
                                ...
                                }}-{{ ReturnProduct.product_cat | textBeautify}}-{{ ReturnProduct.subcategory | textBeautify}}
                            </option>
                        </select>
                    </div>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in card">
                        ...
                        <td>{{item.product_subcategory}}</td>-->
                        <td>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="return_item in return_cart">
                        ...
                        <td>
                            ...
                            <input type="hidden" name="return_sale_price[]" class="form-control" 
                                   ng-model="return_item.return_sale_price" ng-value="return_item.return_sale_price" step="any">
                        </td>
                        <td>
