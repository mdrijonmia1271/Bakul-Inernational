...
<style>
    ...
    @media print {
        aside, nav, .none, .panel-heading, .panel-footer, .print_hide {display: none !important;}
        .panel {
        ...
        .panel-body {position: relative;height: 98vh;}
        .panel-body .footer_img {position: absolute;bottom: 0;left: 0;width: 100%;}
        .custom-header {width: 100%;height: 150px;}
    }
        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                <div class="col-md-12 hide">
                    ...
                    <!--<div class="row">-->
                    <!--    <img style="height:180px !important; width:100% !important;" src="<?php echo site_url('private/images/banner.png'); ?>" />-->
                    <!--</div>-->
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr>
                        ...
                        <td><?=($product ? $product[0]->product_cat : '')?></td>
                        <td><?=($product ? $product[0]->subcategory : '')?></td>
                        <td><?=($product ? $product[0]->brand : '')?></td>
                ...
                <div class="row footer_img hide">
                    <div class="col-md-12">
                        <img style="margin-left: 15px; height: 75px !important; width:100% !important;" src="<?php echo site_url('private/images/footer_img.png'); ?>" />
                    </div>
                </div>
            </div>
