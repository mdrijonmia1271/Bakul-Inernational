        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                <div class="form-group">
                    ...
                    <!--    class="form-control" -->
                    <!--    ng-model='dealer_category' -->
                    <!--    data-placeholder="Select Dealer Category" required>-->
                    ...
                    <div class="col-md-3">
                        <select ui-select2="{ allowClear: true}" class="form-control" ng-model='return_product_code'
                                data-placeholder="Select Return Product" ng-change="addNewReturnProductFn()">
                            <option value="" selected disable>Select Return Product</option>
                            <option ng-repeat="ReturnProduct in allReturnProducts"
                                    value="{{ReturnProduct.product_code}}">
                                {{ ReturnProduct.product_model}}
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <!--<td ng-bind="item.category | textBeautify"></td>-->
                        <!--<td ng-bind="item.subcategory | textBeautify"></td>-->
                        <!--<td ng-bind="item.brand | textBeautify"></td>-->

                        <td>
                            <input type="text" name="product_serial[]" class="form-control" ng-model="item.product_serial">
                        </td>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="return_item in return_cart">
                        ...
                        <td class="td-input" ng-bind="return_item.return_product_model"></td>
                        <!--<td class="td-input" ng-bind="return_item.category | textBeautify"></td>-->
                        <!--<td class="td-input" ng-bind="return_item.subcategory | textBeautify"></td>-->
                        <!--<td class="td-input" ng-bind="return_item.brand | textBeautify"></td>-->

                        <td>
                            <input type="hidden" name="sale_additional" value="sale_purchase">
                            <input type="number" name="return_quantity[]" class="form-control"
                                   ng-model="return_item.return_quantity" step="any">
                        </td>

                        <td>
                            <input type="number" name="return_quantity_kg[]" class="form-control"
                                   step="any">
                        </td>

                        <td>
                            <input type="text" name="return_purchase_price[]" min="0"
                                   ng-model="return_item.return_purchase_price"
                                   ng-value="return_item.return_purchase_price" step="any">
                            <input type="hidden" name="return_sale_price[]" class="form-control" min="0"
                                   ng-model="return_item.return_sale_price" step="any">
                        </td>
                        <td>
                ...
                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select ui-select2="{ allowClear: true }" class="form-control" name="code"
                                            ng-model="party_code" ng-change="findPartyFn(party_code)"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="total_commission" ng-value="getTotalCommissionFn()" class="form-control" step="any" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="total_discount" ng-model="total_discount" class="form-control" placeholder="0" step="any">
                            </div>
                        </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="number" name="paid" ng-model="amount.paid" class="form-control" step="any" ng-disabled="isDisabled">
                                    </div>
                                    <div class="col-md-5">
                ...
                <div class="btn-group pull-right">
                    <input type="submit" name="save" value="Save" class="btn btn-primary" ng-disabled="isDisabled || getGrandTotalFn() == 0">
                </div>
                <p class="text-danger text-center" ng-bind="message"></p>
                <?php echo form_close(); ?>
            </div>
