            ...
            <div class="panel-body" ng-cloak>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in records">
                        ...
                        <input type="hidden" name="dealer_a_price[]" ng-value="item.dealer_a_price">
                        <input type="hidden" name="dealer_b_price[]" ng-value="item.dealer_b_price">
                        <input type="hidden" name="dealer_c_price[]" ng-value="item.dealer_c_price">
                        <input type="hidden"  name="sale_price[]" ng-value="item.sale_price" class="form-control"  step="any">
                        <input type="hidden" name="purchase_commission[]" ng-model="item.purchase_commission" step="any">
                        ...
                        <td>
                            <input type="text" ng-model="item.price" class="form-control" min="0" step="any">
                        </td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="number" ng-model="amount.paid" class="form-control" step="any">
                                    </div>
                                    <div class="col-md-5">
