...
<style>
    @media print{
        ...
        .custom-table>tbody>tr>td {color: #000 !important;}
    }
    .wid-100{
        width: 100px;
    }
            ...
            <div class="panel-body">
                    ...
                    <div class="col-xs-6">
                        <table class="table custom-table">
                            <tr>
                                ...
                                <td><?php echo d_formate($purchase_record[0]->sap_at); ?></td>
                            </tr>
                            <tr>
                                <th>Voucher No :</th>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="view" width="250px"><?php echo filter($val->product_model); ?></td>
                    ...
                    <div class="row">
                        <table class="table custom-table text-right">
                            ...
                            <tr>
                                ...
                                <td><b><?php echo f_number($purchase_record[0]->paid); ?></b></td>
                            </tr>
                            <tr>
