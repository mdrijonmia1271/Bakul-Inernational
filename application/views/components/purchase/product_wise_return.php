        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row new-row-1">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" ng-init="godown_code = '<?php echo $this->data["branch"]; ?>'" ng-model="godown_code" ng-value="godown_code" ng-change="getAllProductsFn()">
                    ...
                    <div class="col-md-2">
                        <select name="party_code" ng-change="setPartyfn(party_code)" ng-model="party_code"  class="selectpicker form-control" data-show-subtext="true" data-live-search="true" required>
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control" placeholder="Quantity" min="0" ng-model="quantity">
                    </div>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            <input type="text" name="quantity[]" class="form-control" min="0" ng-model="item.quantity" max="{{item.maxQuantity}}">
                        </td>
                        <td>
