...
<div class="panel panel-default">
    <div class="panel-heading panal-header">
        ...
        <div class="pull-right">
            <a onclick="window.print()" style="font-size: 14px; cursor: pointer;">
                    ...
                    <tr>
                        ...
                        <td class="none" width="110px">
                            <a  class="btn btn-warning"
                                href="<?php echo site_url('loan_new/loan_new/edit/' . $row->id); ?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>
                            <a  class="btn btn-danger" onclick="return confirm('Are you sure to delete this data?');"
                                href="<?php echo site_url('loan_new/loan_new/delete/' . $row->id); ?>">
