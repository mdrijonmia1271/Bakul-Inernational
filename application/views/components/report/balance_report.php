            ...
            <div class="col-md-4">
                <div class="input-group date" id="datetimepickerFrom">
                    <input type="text" name="date[from]"
                           value="<?php !empty($_POST['date']['from']) ? $_POST['date']['from'] : date('Y-m-d') ?>"
            ...
            <div class="col-md-4">
                <div class="input-group date" id="datetimepickerTo">
                    <input type="text" name="date[to]"
                           value="<?php !empty($_POST['date']['to']) ? $_POST['date']['to'] : date('Y-m-d') ?>"
...
<div class="panel panel-default">
        ...
        <div class="panal-header-title">
            <h1 class="pull-left">Cash Book
                <span style="margin-left:100px;color: #25960a; font-size:20px;">
                    <?php echo (isset($_POST['date']['from']) ? d_formate($_POST['date']['from']) : d_formate(date('Y-m-d'))); ?>
                </span>
                &nbsp; To
                <span style="color: #25960a; font-size:20px;">
                    <?php echo (isset($_POST['date']['to']) ? d_formate($_POST['date']['to']) : d_formate(date('Y-m-d'))); ?>
                </span>
            </h1>
    ...
    <div class="panel-body">
        ...
        <?php
        $total_sale = $client_payment = $client_payment_debit = $totalDealerPayment_debit = $due_Collection = $other_income = $bank_income = $loan_received = $loan_trx_received
        ...
        <div class="row">
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        ...
                        foreach ($creditSaleIncome as $key => $value) {
                            ...
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo d_formate($value->sap_at); ?></td>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        ...
                        foreach ($dealerPayment as $key => $value) { ?>
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo d_formate($value->transaction_at); ?></td>
                                <td><?php echo ($value->inc_code != null) ? $value->inc_code : $value->lpr_code; ?></td>
                                <td><?php echo $value->party_code; ?></td>
                                <td><?php echo $value->name; ?></td>
                                <td><?php 
                                    echo $value->debit;
                                    $client_payment_debit += $value->debit;
                                    $totalDealerPayment_debit += $value->debit;
                                    ?>
                                </td>
                        ...
                        <tr>
                            <th colspan="5" class="text-right">Total</th>
                            <th> <?php echo f_number(($totalDealerPayment_debit), 2); ?> TK</th>
            ...
            <?php if (!empty($subDealerPayment)) { ?>
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        <caption>
                            <h4 style="font-weight: 700; color: #00A8FF;">
                                Sub Dealer Collection
                            </h4>
                        </caption>
                        ...
                        <?php
                        $totalSubDealerPayment = 0;
                        foreach ($subDealerPayment as $key => $value) {
                            ?>
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo d_formate($value->transaction_at); ?></td>
                                ...
                                <td><?php 
                                    echo $value->credit;
                                    $client_payment += $value->credit;
                                    $totalSubDealerPayment += $value->credit;
                                    ?>
                                </td>
                            </tr>
                        <?php } ?>
                        ...
                        <tr>
                            <th colspan="5" class="text-right">Total</th>
                            <th> <?php echo f_number(($totalSubDealerPayment), 2); ?> TK</th>
                        </tr>
                    </table>
                </div>
            <?php } ?>
            
            <?php if (!empty($userDealerPayment)) { ?>
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        <caption>
                            <h4 style="font-weight: 700; color: #00A8FF;">
                                User Dealer Collection
                            </h4>
                        </caption>
                        ...
                        <?php
                        $totalUserDealerPayment = 0;
                        foreach ($userDealerPayment as $key => $value) {
                            ?>
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo d_formate($value->transaction_at); ?></td>
                                ...
                                <td><?php 
                                    echo $value->credit;
                                    $client_payment += $value->credit;
                                    $totalUserDealerPayment += $value->credit;
                                    ?>
                                </td>
                            </tr>
                        <?php } ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($dueCollection as $key => $value) {
                            ...
                            if ($due_amount[0]->paid > 0) {
                                ...
                                <tr>
                                    <td><?php echo $key + 1; ?></td>
                                    <td><?php echo d_formate($value->date); ?></td>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($bankIncome as $key => $value) { ?>
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo d_formate($value->transaction_date); ?></td>
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($SaleReturnInfo as $key => $row) {
                            ...
                            <tr>
                                ...
                                <td><?php echo d_formate($row->date); ?></td>
                                <td>
                                    <?php
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($allCost as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    echo $field_amount[0]->amount;
                                    $total_cost += $field_amount[0]->amount;
                                ?>
                                </td>
                            </tr>
                        <?php } ?>
            ...
            $totalIncome = $total_sale + $client_payment + $due_Collection + $other_income + $bank_income + $loan_received + $loan_trx_received;

            $totalCost = $client_payment_debit + $total_purchase + $totalSaleReturn + $supplier_payment + $totalCash + $total_cost + $bank_cost + $loan_paid + $loan_trx_paid;
