        ...
        <div class="panel panel-default none">
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1>Search Client Wise Item Report</h1>
                </div>
            </div>
                     ...
                     <div class="col-md-2 mb_3">
                        <select name="party_code" class="selectpicker form-control" data-show-subtext="true"
                            ...
                            if (!empty($allClient)) {
                                ...
                                ?>    
                                  <option value="<?php echo $row->code; ?>" > <?php echo $row->code.'-'.$row->name.'-'.$row->mobile.'-'.$row->address;  ?></option>
                            <?php                                
                                }
                                } 
                            ?>
                ...
                <table class="table table-bordered">
                    ...
                    foreach ($results as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?= filter($value->subcategory) ?></td>
                            <td><?= filter($value->brand) ?></td>
