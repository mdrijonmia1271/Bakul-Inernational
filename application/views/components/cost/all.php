                    ...
                    <tr>
                        ...
                        <td class="none text-center " style="width: 110px;">
                            ...
                            <a  title="edit" class="btn btn-warning" 
                                href="<?php echo site_url('cost/cost/edit/'.$value->id);?>" >
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>
                            <a  title="Delete" class="btn btn-danger" 
                                onclick="return confirm('Are you sure want to delete this Cost?');" 
                                href="<?php echo site_url('cost/cost/delete_cost/'.$value->id);?>" >
