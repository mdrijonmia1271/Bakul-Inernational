<script src="<?php echo site_url('private/js/ngscript/addCommitmentSuppliterCtrl.js?'.time())?>"></script>
...
<div class="container-fluid" ng-controller="addCommitmentSuppliterCtrl" ng-cloak>
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading none">
                <div class="panal-header-title pull-left">
                    <h1>All Supplier Commitments</h1>
                </div>
            ...
            <div class="panel-body none">
                ...
                echo form_open('supplier/commitment/view_all', $attr); ?>
               ...
               <?php if(checkAuth('super')) { ?>
                ...
                <div class="col-md-3 mb-15">
                    <select ui-select2="{ allowClear: true}" class="form-control" name="search[status]" ng-model="status" ng-init="status=''" data-placeholder="Select A Status">
                ...
                <div class="col-md-3 mb-15">
                    <select ui-select2="{ allowClear: true}" class="form-control" name="search[party_code]" ng-model="party_code" ng-change="getUserInfoFn()" data-placeholder="Select Supplier">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo d_formate($commitment->date); ?></td>
                        ...
                        <td><?php echo filter($commitment->status); ?></td>
                        <td class="none text-center">
                            <a title="view" class="btn btn-info" href="<?php echo site_url('supplier/commitment/view/'.$commitment->id);?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                            
                            <?php 
                                /*$privilege = $this->data['privilege'];
                                if($privilege != 'user'){*/
                            ?>
                                <a title="Edit" class="btn btn-primary"  href="<?php echo site_url('supplier/commitment/edit/'.$commitment->id); ?>" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Commitment?');" href="<?php echo site_url('supplier/commitment/delete/'.$commitment->id);?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>                         
                            <?php  //} ?>      
                        </td>
                    </tr>
                    <?php }  ?>
