        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row none" style="margin-bottom: 15px">
                    <div class="col-md-4">
                        <input type="text" id="myInput" class="form-control" onkeyup="myFunction()" placeholder="Search for Showroom.." title="Type in a name">
                    </div>
                </div>
                ...
                <table class="table table-bordered"  id="myTable" >
                    ...
                    <tr>
                        ...
                        <td> <?php echo d_formate($account->datetime); ?> </td>
                        <td> <?php echo get_name('godowns','name',array('code' => $account->godown_code)); ?> </td>
