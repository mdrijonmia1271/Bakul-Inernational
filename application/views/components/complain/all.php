                ...
                <div class="row">
                    <div class="col-md-4">
                        <select ui-select2="{ allowClear: true}" class="form-control"
                                name="complainId" ng-model="complainId" data-placeholder="Select client">
                            <option value="" selected disable></option>
                            <?php
                            if (!empty($allClient)){
                                foreach ($allClient as $option){
                                    echo '<option value="'. $option->id .'">'. $option->name .'-'. $option->mobile .'</option>';
                                }
                            } ?>
                        </select>
                    </div>
