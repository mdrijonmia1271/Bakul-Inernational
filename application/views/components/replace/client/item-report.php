        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left">Client Replace Item Report</h1>
                ...
                <table class="table table-bordered">
                    ...
                    if (!empty($results)) {
                        foreach ($results as $key => $row) {
                            ...
                            $totalReceive  += ($row->status == 'client_receive' ? $row->quantity : 0);
                            $totalDelivery += ($row->status == 'client_delivery' ? $row->quantity : 0);
