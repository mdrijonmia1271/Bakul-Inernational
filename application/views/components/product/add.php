        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 input-group">
                        <input type="number" name="retail_sale_price" min="0" value="0" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_a_price" min="0" value="0" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_b_price" min="0" value="0" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_c_price" min="0" value="0" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
