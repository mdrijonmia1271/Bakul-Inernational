            ...
            <div class="panel-heading panal-header">
                <div class="panal-header-title">
                    ...
                    <a class="btn btn-primery pull-right" style="font-size: 14px; margin-top: 0;"
                        onclick="window.print()"><i class="fa fa-print"></i> Print 1</a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Dealer A Price </th>
                            <th class="text-center">Dealer B Price </th>
                            <th class="text-center">Dealer C Price </th>
                        ...
                        <tr
                            ...
                            <!--<td class="text-center"> {{ row.retail_sale_price }} </td>-->
                            <td class="text-center"> {{ row.dealer_a_price }} </td>
                            <td class="text-center"> {{ row.dealer_b_price }} </td>
                            <td class="text-center"> {{ row.dealer_c_price }} </td>
                            ...
                            ?>
                                <a  class="btn btn-warning" title="Edit"
                                    href="<?php echo site_url('product/product/edit/{{ row.id }}');?>">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                                <a  class="btn btn-danger" title="Delete"
                                    onclick="return confirm('Are you sure want to delete this Product?');"
                                    href="<?php echo site_url('product/product/delete/{{ row.id }}') ;?>">
