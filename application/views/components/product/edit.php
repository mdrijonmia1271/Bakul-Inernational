            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 input-group">
                        ...
                        <input type="hidden"  name="sub_category" value="na">
                        <input type="hidden"  name="brand" value="na">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Retail Sale Price </label>
                    <div class="col-md-5 input-group">
                        <input type="number" name="retail_sale_price" min="0" ng-value="product.retail_sale_price" class="form-control" step="any">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Dealer A Price </label>
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_a_price" min="0" ng-value="product.dealer_a_price" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-md-2 control-label">Dealer B Price </label>
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_b_price" min="0" ng-value="product.dealer_b_price" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-md-2 control-label">Dealer C Price </label>
                    <div class="col-md-5 input-group">
                        <input type="number" name="dealer_c_price" min="0" ng-value="product.dealer_c_price" class="form-control" step="any">
                        <!-- <div class="input-group-addon">TK / kg</div> -->
                    </div>
                </div>
