        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="customer_type" id="customer_type" class="form-control" data-show-subtext="true" data-live-search="true" required>
				...
				<div class="form-group" style="display:none" id="reference_dealer">
                    <label class="col-md-3 control-label">Reference Dealer</label>
                    <div class="col-md-5">
                ...
                <script>
                    var customer_type = document.querySelector('#customer_type');
                    var reference_dealer = document.querySelector('#reference_dealer');
                    if(customer_type){
                        customer_type.addEventListener('change', ()=>{
                            if(customer_type.value == 'sub_dealer'){
                                reference_dealer.style.display = 'block';
                            }else{
                                reference_dealer.style.display = 'none';
                            }
                        });
                    }
                </script>
