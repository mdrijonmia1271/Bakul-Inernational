...
<div class="container-fluid" ng-controller="addCommitmentCtrl" ng-cloak>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body none">
               ...
               <?php if(checkAuth('super')) { ?>
                ...
                <div class="col-md-3 mb-15">
                    <select ui-select2="{ allowClear: true}" class="form-control" name="search[status]" ng-model="status" ng-init="status='new'" data-placeholder="Select A Status">
    ...
    <tr>
        ...
        <td class="none text-center">
            <a title="view" class="btn btn-info" href="<?php echo site_url('client/commitment/view/'.$commitment->id); ?>"><i class="fa fa-eye"></i></a>
            <a title="Edit" class="btn btn-primary" href="<?php echo site_url('client/commitment/edit/'.$commitment->id); ?>"><i class="fa fa-pencil"></i></a>
            <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Commitment?');" href="<?php echo site_url('client/commitment/delete/'.$commitment->id); ?>"><i class="fa fa-trash-o"></i></a>
        </td>
    </tr>
    <?php } // endforeach ?>
    
    <!-- এইটা শুধু একবার আসবে, টেবিলের একদম শেষে -->
    <tr>
        <td colspan="7" style="text-align: right;"><strong>Total Due</strong></td>
        <td><strong><?php echo number_format($totalDue, 2); ?></strong></td>
        <td colspan="2"></td>
    </tr>
</table>
