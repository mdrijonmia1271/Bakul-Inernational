            ...
            <div class="panel-body">
                ...
                <?php
                    ...
                    if ($transactionRec != null) {
                        ...
                        $balance = $total_debit -  $total_credit + $records->initial_balance + $comission;
                    }else{
                   ...
                   if ($partyInfo[0]->customer_type == 'dealer') {
                       ?>
                       ...
                       <div class="col-xs-12 row">
                           <table class="table table-bordered table-hover">
                               ...
                               <tr>
                                   ...
                                   <th>Remission</th>
                                   <td class="text-right"><?php echo($records->remission ? $records->remission : 0); ?></td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                    <th>PR No</th>
                                    <td class="text-right"><?php echo $records->pr_no; ?></td>
                                    <th>&nbsp;</th>
                                    <td>&nbsp;</td>
                                </tr>
                           </table>
                ...
                <div class="col-xs-12 row">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                         ...
                         <tr>
                            <th>PR No</th>
                            <td class="text-right"><?php echo ucfirst($records->pr_no); ?></td>
                            <th>&nbsp;</th>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
