            ...
            <div class="panel-body">
               ...
               <?php if(checkAuth('super')) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select ui-select2="{ allowClear: true}" class="form-control" name="code" ng-model='code'
                          ...
                          <option ng-repeat="row in clientList" value="{{row.code}}">{{ row.code }}-{{ row.name }}-{{ row.mobile }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" name="payment" ng-model="payment" placeholder="0.00" class="form-control" step="any" min="0"
                            required>
                    </div>
                </div>
                ...
                <div ng-show="transactionType" ng-init="transactionType = false">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="remission" ng-model="remission" class="form-control" placeholder="0.00">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1">
                         <div class="checkbox">
                            <label>
                                <input type="checkbox" checked name="send_sms" style="padding-left: 5px; transform: scale(2);">
                            </label>
                          </div>
                    </div>
                </div>
