            ...
            ?>
                <div class="row none">
                    ...
                    <?php if($this->data['privilege'] == 'super') { 
                        ...
                        $where['type'] ="client";
                        $where['trash'] =0;
                        $allClient = get_result('parties',$where);
                    }else{ 
                ...
                <?php echo form_close(); ?>
                <p class="none">
                    <span style="color: green;font-weight: bold;">Green = Receivable</span>&nbsp;
                    <span style="color: red;font-weight: bold;">Red = Payable</span>
                </p>
            ...
            */
            for(key in respons){
              ...
              data_row += `
                          ...
                          <td style="text-transform: capitalize;">${single_record['customer_type'].replace('_', ' ')}</td>
