      ...
      <div class="panel panel-default">
        ...
        <div id='printMe2'>
          ...
          <div id='printMe2'>
            <div class="col-md-offset-2 col-md-8">
            	<table class="table table-bordered table-hover">
            	    <tr>
            	        <th colspan="7" class="text-center text-primary">Today Retail Commitment's List
            	        <a class="btn btn-primery pull-right none" style="font-size: 14px; margin-top: -10px;" id="printBtn2" onclick="printDiv2('printMe2')"><i class="fa fa-print"></i> Print</a></th>
            	    </tr>
            	    <tr>
            	        <th width="45px">SL</th>
            	    ...
            	    <?php 
            	       if(!empty($irregularInstallment)){
            	        foreach($irregularInstallment as $key => $val){
            	    ?>
            	    <tr>
            	        <td><?php echo $key+1;?></td>
            	        <td><?php echo filter($val['party_code']); ?></td>
            	        <td><?php echo $val['voucher_no'];?></td>
            	        <td><?php echo $val['total_bill'];?></td>
            	        <td><?php echo $val['paid']; ?></td>
                        <td><?php echo $val['due']; ?></td>      
            	    </tr>
            	    <?php }} ?>
            	</table>
            </div>
        ...
        <div id='printMe3'>
            <div class="col-md-offset-2 col-md-8">
            	<table class="table table-bordered table-hover">
            	    <tr>
            	        <th colspan="7" class="text-center text-primary">All Customer Complain
            	        <a class="btn btn-primery pull-right none" style="font-size: 14px; margin-top: -10px;" id="printBtn3" onclick="printDiv3('printMe3')"><i class="fa fa-print"></i> Print</a></th>
            	    </tr>
            	    <tr>
            	        <th width="50">SL</th>
                        <th>Date</th>
...
function printDiv3(divName3){
    var printBtn3 = document.getElementById('printBtn3').style.display = 'none';
